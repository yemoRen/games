...
- **v1.0.7 已发布**（2026-09-08，tag `v1.0.7` 指向本次提交）：遣散二次确认（内联确认防误触）/ 进图当前血被压到 baseNoGear 修复（yemo 1935→1415）/ 副本内换装体质·耐力应改最大血 / 遣散按钮 window.confirm 失效改内联确认 / 潜行绕行固定 3 分钟 五项。package.json 已 bump 到 `1.0.7`。
